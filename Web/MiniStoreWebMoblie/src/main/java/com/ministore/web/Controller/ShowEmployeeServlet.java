...
import com.ministore.web.DAO.EmployeeDAO;
...
//    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      //  processRequest(request, response);
       String url ="components_manage_employee.jsp";
         try {
            
            EmployeeDAO dao = new EmployeeDAO();
            
            ArrayList<EmployeeDTO> result = dao.ShowEmp();
            
            if (result != null) {
                request.setAttribute("RESULT_EMP", result);

 ...
 * @author daigi
 */
@WebServlet(name = "ShowSupplierServlet", urlPatterns = {"/ShowSupplierServlet"})
public class ShowSupplierServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url ="components_manage_supplier.jsp";
        try {
            
            SupplierDAO dao = new SupplierDAO();
            dao.ShowSupplier();
            ArrayList<SupplierDTO> result = dao.ShowSupplier();
            if (result != null) {

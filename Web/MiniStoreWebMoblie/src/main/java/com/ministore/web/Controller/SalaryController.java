...
public class SalaryController extends HttpServlet {
    ...
    private final String SALARYPAGE = "components_manage_salary.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = SALARYPAGE;
        try {
            HttpSession session = request.getSession();
            SalaryDAO dao = new SalaryDAO();
            ArrayList<SalaryDTO> list = dao.getAllSalary();
            session.setAttribute("SALARY", list);

<%-- 
    Document   : components_create_product
    Created on : Jul 18, 2023, 9:53:02 PM
    Author     : daigi
--%>
...
<!--                            <li>
  ...
  document.getElementById("txtPicture").addEventListener("change", function (event) {
    ...
    if (file) {
      ...
      <form action="CrearteProductServlet" method="POST" enctype="multipart/form-data">
          <div class="form-row">
              <span class="form-label">SKU</span>   
              <input type="text" name="txtSku" > </br> 
              </br> 
          </div> 
          ...
          <div class="form-row">
              ...
              <input type="text" name="txtNameProduct" > </br> 
              </br> 
          </div> 

          <div class="form-row">
              <span class="form-label"> ID Supplier</span> 
              <input type="text" name="txtIdSup" > </br> 
              </br> 
          </div> 

          <div class="form-row">
              <span class="form-label"> MFG</span> 
              <input type="text" name="txtMfg" > </br> 
              </br> 
          </div> 

          <div class="form-row">
              <span class="form-label"> EXP</span>
              <input type="text" name="txtExp" > </br> 
              </br> 
          </div> 

          <div class="form-row">
              <span class="form-label"> Date Import</span>
              <input type="text" name="txtDateImport" > </br> 
              </br> 
          </div> 
          ...
          <div class="form-row">
              ...
              <input type="checkbox" name="txtStatus" value="ON" checked="checked"/></br> 
              </br> 
          </div> 
          <button type="submit" class="btn btn-primary" name="btAction" >Add</button>
      </form>

<%-- 
    Document   : components_manage_product.jsp
    Created on : Jul 13, 2023, 6:44:36 PM
    Author     : daigi
--%>
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Datatables</h5>
               <a href="components_create_product.jsp"> Create</a>
              <c:set var="result" value="${requestScope.RESULT_ITEMS}"/>
...
<!--                        <select name="txtTypeProduct">
                         <c:forEach items="${productTypes}" var="type">
                           <option value="${type}" ${dto.typeProduct == type ? 'selected' : ''}>
                         ${type}
                           </option>
                          </c:forEach>
                        </select>-->
                    ...
                    <td>
<!--                       <input type="text" name="txtNameProduct" value="${dto.nameProduct}" />-->
                        ${dto.nameProduct}
                    </td>
                    <td>
                        <select name="txtIdSupplier">
                         <c:forEach items="${nameSupplier}" var="type">
                           <option value="${type}" ${dto.nameSupplier == type ? 'selected' : ''}>
                         ${type}
                           </option>
                          </c:forEach>
                        </select>
<!--                        <input type="text" name="txtIdSupplier" value="${dto.nameSupplier}" />-->
                    </td>
                    <td> ${dto.MFG}</td>
                    <td> ${dto.EXP}</td>
                    <td> ${dto.dateImport}</td>
                    <td>
                        <c:if test="${dto.statusP== true}">
                            AVAILABLE
                        </c:if>
                        <c:if test="${dto.statusP== false}">
                            SOLD OUT
                        </c:if>
                    </td>
                    <td>
                        <img src="data:image/jpeg;base64,${dto.pictureProduct}" alt="Product Image" width="100" height="100">
                    </td>
                     <td>
                       
                       <a href="UpdateProductsServlet?Id=${dto.sku}"> Update</a>
                     </td>
                  </tr>

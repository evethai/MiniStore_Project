<%-- 
    Document   : components_update_unit
    Created on : Jul 19, 2023, 2:49:50 PM
    Author     : daigi
--%>
...
<!--                            <li>
  ...
  <main id="main" class="main">
      ...
      <form action="UpdateUnitServlet" method="POST" >
          <input type="hidden" name="txtIdUnit" value="${pr.ID_Unit}">
          <div class="form-row">
              <span class="form-label">Quantity </span>   
              <input type="number" name="TxtQuantity" value="${pr.quantity}">  </br>
              </br>
          </div> 
          <div class="form-row">
              <span class="form-label">Price Export</span>   
              <input type="number" name="txtPriceExport" value="${pr.priceExport}" step="0.01">  </br>
              </br>
          </div> 

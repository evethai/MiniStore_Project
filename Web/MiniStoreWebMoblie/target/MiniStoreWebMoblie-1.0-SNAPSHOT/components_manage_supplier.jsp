<%-- 
    Document   : components_manage_supplier
    Created on : Jul 14, 2023, 10:18:27 AM
    Author     : daigi
--%>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <a href="components_create_supplier.jsp"> Create</a>
              ...
              <table class="table datatable">
                ...
                <form action="DispathController" method="POST">
                  <tr>
                    <td>${dto.idSupplier}</td>
                    <td>${dto.nameSupplier}</td>
                    <td>${dto.address}</td>
                    <td>${dto.note}</td>
                    <td>
                       <a href="UpdateSupplierServlet?Id=${dto.idSupplier}"> Update</a>
                     </td>

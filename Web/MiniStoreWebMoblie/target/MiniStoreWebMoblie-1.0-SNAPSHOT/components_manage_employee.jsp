<%-- 
    Document   : components_manage_employee
    Created on : Jul 19, 2023, 10:34:29 PM
    Author     : daigi
--%>

<%@page import="com.ministore.web.DTO.EmployeeDTO"%>
...
<!--               <a href="components_create_product.jsp"> Create</a>-->
              <c:set var="result" value="${requestScope.RESULT_EMP}"/>
              ...
              <table class="table datatable">
                ...
                <form action="DispathController" method="post">
                  <tr>
                    <td>${dto.idEmp}
                        <input type="hidden" name="txtIdEmp" value="${dto.idEmp}" />
                    </td>
                    <td>
                        ${dto.fullname}
                    </td>
                    ...
                    <td> ${dto.username}</td>
                    <td>
                        <c:if test="${dto.isactive== true}">
                            ATTENDED
                        </c:if>
                        <c:if test="${dto.isactive== false}">
                            ABSENTED
                        </c:if>
                    </td>
                    <td>
                       <c:if test="${dto.roles== 2}">
                            EMPLOYEE
                        </c:if>
                        <c:if test="${dto.roles== 3}">
                            GUARD
                        </c:if>
                    </td>
                    <td>
                        <img src="data:image/jpeg;base64,${dto.picture}" alt="Product Image" width="100" height="100">
                    </td>
                    <td> ${dto.snpt}</td>
<!--                     <td>

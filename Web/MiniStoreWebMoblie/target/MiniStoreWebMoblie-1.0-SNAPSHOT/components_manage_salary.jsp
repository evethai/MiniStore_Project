...
<!--                                <h5 class="card-title">Datatables</h5>
                                ...
                                <c:set var="salary" value="${sessionScope.SALARY}"/>
                                    ...
                                    <table class="table datatable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Allowance salary</th>
                                                <th scope="col">Basic salary</th>
                                                <th scope="col">Salary befor tax</th>
                                                <th scope="col">Tax</th>
                                        ...
                                        <tbody>
                                            <c:forEach var="dto" items="${salary}">
                                                <tr>
                                                    <td scope="col">${dto.id}</td>
                                                    <td scope="col">${dto.idEmp}</td>
                                                    <td scope="col"><c:set var="formatted"><fmt:formatNumber value="${dto.salaryHour}" pattern="#,###,###" /></c:set>${formatted}</td>

                                                        <!--<td scope="col">${dto.salaryHour}</td>-->

                                                    <td scope="col"><c:set var="formatted"><fmt:formatNumber value="${dto.subSalary}" pattern="#,###,###" /></c:set>${formatted}</td>

                                                        <!--<td scope="col">${dto.subSalary}</td>-->
                                                    <td scope="col"><c:set var="formatted"><fmt:formatNumber value="${dto.basicSalary}" pattern="#,###,###" /></c:set>${formatted}</td>

<!--                                                    <td scope="col">${dto.basicSalary}</td>-->
                                                    <td scope="col"><c:set var="formatted"><fmt:formatNumber value="${dto.salaryBeforTax}" pattern="#,###,###" /></c:set>${formatted}</td>

                                                        <!--<td scope="col">${dto.salaryBeforTax}</td>-->
                                                    <td scope="col"><c:set var="formatted"><fmt:formatNumber value="${dto.tax}" pattern="#,###,###" /></c:set>${formatted}</td>

                                                        <!--<td scope="col">${dto.tax}</td>-->
                                                    <td scope="col"><c:set var="formatted"><fmt:formatNumber value="${dto.advSalary}" pattern="#,###,###" /></c:set>${formatted}</td>

                                                        <!--<td scope="col">${dto.advSalary}</td>-->
                                                    <td scope="col"><c:set var="formatted"><fmt:formatNumber value="${dto.finalSalary}" pattern="#,###,###" /></c:set>${formatted}</td>

                                                        <!--<td scope="col">${dto.finalSalary}</td>-->
                                                    <td scope="col">${dto.dateOut}</td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>

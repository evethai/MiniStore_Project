<%-- 
    Document   : components_create_unit
    Created on : Jul 19, 2023, 3:31:18 PM
    Author     : daigi
--%>
...
<!--                            <li>
  ...
  <main id="main" class="main">
      ...
      <form action="CreateUnitServlet" method="POST" >
          <div class="form-row">
              <span class="form-label">ID Unit</span>   
              <input type="text" name="txtIDunit" > </br> 
              </br> 
          </div> 
          ...
          <div class="form-row">
              <span class="form-label"> Name Unit</span> 
              <input type="text" name="txtNameUnit" > </br> 
              </br> 
          </div> 

          <div class="form-row">
              <span class="form-label"> Quantity</span> 
              <input type="number" name="TxtQuantity" value="0">  </br>
              </br> 
          </div> 

          <div class="form-row">
              <span class="form-label"> Price Import</span>
              <input type="number" name="txtPriceImport" value="0">  </br>
              </br> 
          </div> 

          <div class="form-row">
              <span class="form-label"> Price Export</span>
             <input type="number" name="txtPriceExport" value="0">  </br>
              </br> 
          </div> 

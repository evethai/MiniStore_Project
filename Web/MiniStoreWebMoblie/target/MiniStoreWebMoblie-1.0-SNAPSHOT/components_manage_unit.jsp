<%-- 
    Document   : components_manage_unit
    Created on : Jul 13, 2023, 10:11:41 PM
    Author     : daigi
--%>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <a href="components_create_unit.jsp"> Create</a>
              <c:set var="result" value="${requestScope.RESULT_ITEM}"/>
              ...
              <table class="table datatable">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Price Import</th>
                    <th scope="col">Price Export</th>
                ...
                <form action="DispathController" method="POST">
                  <tr>
                    ...
                    <td> ${dto.nameUnit}</td>
                    <td> ${dto.quantity}</td>
                    <td> ${dto.priceImport}</td>
                    <td> ${dto.priceExport}</td>
                    <td>
                       <a href="UpdateUnitServlet?Id=${dto.ID_Unit}"> Update</a>
                     </td>
                  </tr>
                </form>
                </c:forEach>
